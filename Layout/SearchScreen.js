...
//   const handleSetTxtSearch = async (txt) => {
//     let url = `${URL}/products/search-product`;

//     try {
//       const { data: { response } } = await axios.get(url, { params: { value: txt } })
...
//         <TextInput onChangeText={handleSetTxtSearch}
...
//                   renderItem={({ item }) =>
//                     <TouchableOpacity key={item._id} onPress={() => { navigation.navigate('DetailScreen', { item: item }) }}
