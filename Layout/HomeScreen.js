    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ width: screenWidth , height: 320 }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('DogsSceen', { data: ListDogs })} style={styles.newSP}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity onPress={() => navigation.navigate('DetailProduct', { item: item })} style={styles.itemDogs}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('DogsSceen', { data: ListDogs })} style={styles.Xemthem}>
          <View />
        ...
        />
        <TouchableOpacity onPress={() => navigation.navigate('CatsSceen', { data: ListCats })} style={styles.Xemthem}>
          <View />
          <Text style={{ fontSize: 14, color: 'green', fontWeight: 'bold', textDecorationLine: 'underline' }}>Xem thêm</Text>
        </TouchableOpacity>
